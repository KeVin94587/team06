...
class EmperorsTableSeeder extends Seeder
{
    public function generateRandomEmperors() {
        ...
        '宋元兇 劉劭','宋孝武帝 劉駿','宋前廢帝 劉子業','宋明帝 劉彧','宋後廢帝 劉昱','宋順帝 劉准','齊高帝 蕭道成',
        '齊武帝 蕭賾','齊鬱林王 蕭昭業','齊海陵王 蕭昭文','齊明帝 蕭鸞','齊東昏侯 蕭寶卷','齊和帝 蕭寶融','梁武帝 蕭衍',
        '梁簡文帝 蕭綱','梁元帝 蕭繹','梁敬帝 蕭方智','梁武陵貞獻王 蕭紀','梁永嘉王 蕭莊','梁宣帝 蕭詧','梁明帝 蕭巋',
        '陳武帝 陳霸先','陳文帝 陳蒨','陳廢帝 陳伯宗','陳宣帝 陳頊','陳後主 陳叔寶'];
